    ...
    ?>
        <div class="col-8">
            ...
            <div class="row">
                ...
                ?>
                <p>
                    <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="<?php echo '#'.$mes['classe'];?>" aria-expanded="false" aria-controls="<?php echo $mes['classe'];?>"><?php echo $mes['data'];?></button>
                </p>
                <?php
                }
                ?>
            ...
            ?>
                ...
                <div style='border: solid 1px grey;' class="row collapse" id="<?php echo $mes['classe'];?>">
                    <?php
