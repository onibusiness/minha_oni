...
<section class="container-fluid background_white">
    ...
    <div class="row background_white"  >
        ...
        <div class="col-md-6 px-5">
            ...
            <div class="pt-4">
                ...
                <div class="row px-3">
                    ...
                    <div class="col-md-4 pt-3">
                        <code class="petro_escuro">
                            &lt;p class="petro_escuro"&gt;</p>
                        </code>
                    </div>
                    <div class="col-md-4 pt-3">
                        <code class="yellow">
        ...
        <div class="col-md-6 px-5">
            <div class="row">
                ...
                <div class="col-md-6 background_pink py-2">
                    <code class="petro">
                        &lt;div class="background_pink"/&gt;
                    </code>
                </div>
                <div class="col-md-6 background_white py-2">
                    <code class="onipink">
                        &lt;div class="background_white"/&gt;
                    </code>
                </div>
                <div class="col-md-6 background_offwhite py-2">
                    <code class="petro">
                        &lt;div class="background_offwhite"/&gt;
                    </code>
                </div>
                <div class="col-md-6 background_grey py-2">
                    <code class="petro_escuro">
                        &lt;div class="background_grey"/&gt;
                    </code>
                </div>
                <div class="col-md-6 background_green py-2">
                    <code class="white">
...
<section class="container-fluid background_white p-5"> 
...
&lt;/div&gt;</pre>
        ...
        <div class="col-12 col-md-8">
            <div class="atomic_card p-4 background_petro">
            ...
            &lt;div class="col-md-6"&gt;
                ...
                &lt;div class="d-flex"&gt;
                    ...
                    &lt;div class="col-md-4 d-flex justify-content-around align-self-center"&gt;
                        ...
                        &lt;p class="competency_sphere background_green" /&gt;
                        &lt;p class="competency_sphere background_green" /&gt;
                        &lt;p class="competency_sphere background_grey" /&gt;
                        &lt;p class="competency_sphere background_grey" /&gt;
                    &lt;/div&gt;
                &lt;/div&gt;
